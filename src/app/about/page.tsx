    ...
    <div className="max-w-[1440px] mx-auto px-margin-mobile md:px-margin-desktop py-12 overflow-hidden">
      ...
      <section className="py-16 md:py-24 border-t border-outline-variant/20 dark:border-slate-800/80 mt-16 grid grid-cols-1 md:grid-cols-2 gap-12">
        <ScrollReveal direction="up" delay={0.1}>
          <div className="glass-card h-full p-8 md:p-10 rounded-[2rem] border-outline-variant/30 space-y-4 dark:bg-slate-900/30">
      ...
      {/* Core Values */}
      <ScrollReveal direction="fade" duration={1} className="py-16 bg-surface-container-low dark:bg-slate-900/30 rounded-[2.5rem] px-8 md:px-12 my-12">
      ...
      {/* Call to action */}
      <ScrollReveal direction="up" className="py-16 text-center space-y-6 max-w-2xl mx-auto">
        ...
        <Link href="/contact" className="inline-block">
          <button className="px-8 py-3.5 bg-primary text-on-primary dark:bg-slate-100 dark:text-slate-900 font-bold rounded-xl hover:bg-secondary dark:hover:bg-secondary dark:hover:text-white transition-all flex items-center gap-2 active:scale-95 shadow-lg shadow-secondary/10 cursor-pointer">
