...
export default function ServicesPage() {
  ...
  return (
    <div className="max-w-[1440px] mx-auto px-margin-mobile md:px-margin-desktop py-12">
      ...
      {/* Category Tabs */}
      <div className="flex gap-2 overflow-x-auto pb-4 mb-10 scrollbar-none border-b border-outline-variant/20 dark:border-slate-800/80">
      ...
      {/* Sticky Bottom Note */}
      <div className="mt-16 p-6 rounded-2xl bg-surface-container-low border border-outline-variant/30 dark:bg-slate-900/20 dark:border-slate-800 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <Link href="/contact">
          <button className="px-6 py-3 bg-secondary text-white font-bold rounded-xl hover:bg-primary transition-colors text-sm shrink-0 whitespace-nowrap active:scale-95 shadow-sm">
